/**
 * Created by Damian.Kelly on 01/06/2016.
 */
/**
 * @author: @AngularClass
 */
...
const API = 'https://martian.creative-assembly.com';
const METADATA = webpackMerge(commonConfig.metadata, {
    HOST: HOST,
    PORT: PORT,
    ENV: ENV,
    API: API,
    EXTERNAL_URL_PREFIX: 'https://d2mgfhkgxmsoab.cloudfront.net/',	
    title: 'Titan CMS Client',
    baseUrl: '/titanclient/',
    HMR: false
});
